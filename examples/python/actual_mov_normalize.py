            ...
            if not args[0].no_display:
                ...
                for d in range(len(datum.poseKeypoints)): #識別されている人数だけ回す
                    ...
                    if sekitui != 0:
                        ...
                        person_image = imageToProcess[int(keypoint_minmax_normalize[0][1]) - 30: int(keypoint_minmax_normalize[1][1]) + 30, int(keypoint_minmax_normalize[0][0]) - 30  : int(keypoint_minmax_normalize[1][0]) + 30]
